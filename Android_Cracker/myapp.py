...
def check_packages():
    ...
    if (
        ...
        choice = input(
            f"\n{color.GREEN}Do you still want to continue to Android Cracker ?{color.WHITE}     Y / N > "
        ).lower()
...
def display_menu():
    ...
    print(banner.head + selected_banner , banner.menu)
...
def get_screenshot():
    ...
    if screenshot_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving screenshot to Android-cracker/{screenshot_location}\n{color.WHITE}"
        )
    else:
        print(
...
def screenrecord():
    ...
    if screenrecord_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving video to Android-cracker/{screenrecord_location}\n{color.WHITE}"
        )
    else:
...
def pull_file():
    ...
    if pull_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving file to Android-cracker/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_whatsapp():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving data to Android-cracker/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_screenshots():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Screenshots to Android-cracker/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_camera():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Photos to Android-cracker/{pull_location}\n{color.WHITE}"
        )
    else:
...
def open_link():
    print(
        f"\n{color.YELLOW}Enter URL              {color.CYAN}Example : https:// {color.WHITE}"
    )
    url = input("> ")
...
def dump_sms():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving SMS file to Android-cracker/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_contacts():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Contacts file to Android-cracker/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_call_logs():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Call Logs file to Android-cracker/{pull_location}\n{color.WHITE}"
        )
    else:
        print(
...
def extract_apk():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving APK file to Android-cracker/{pull_location}\n{color.WHITE}"
        )
    else:
...
def update_me():
    print(f"{color.YELLOW}\nUpdating Android-cracker\n{color.WHITE}")
    print(f"{color.GREEN}Fetching latest updates from GitHub\n{color.WHITE}")
    os.system("git fetch")
    print(f"{color.GREEN}\nApplying changes\n{color.WHITE}")
    os.system("git rebase")
    print(f"{color.CYAN}\nPlease restart Android-cracker{color.WHITE}")
    exit_Android_cracker()


def visit_me():
    os.system(f"{opener} https://github.com/tushargurav28")
    print("\n")
...
def record_audio(mode):
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving recordings to Android-cracker/{pull_location}\n{color.WHITE}"
        )
    else:
